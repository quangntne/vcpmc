...
interface IModalUploadUser{
  token:string;
  user:User;
}

const ModalUploadUserSelector:Selector<RootState,IModalUploadUser> =(state:RootState)=>{
  return {
...
const ModalUploadUser = ({ dataModal, onCancelModal, userName }) => {
  ...
  const {user}= useSelector(ModalUploadUserSelector);
  ...
  const { addUser, updateUser, updateExtend, getAllRole } = userPresenter;
  const { getRoleInGroup } = rolePresenter;
  ...
  useEffect(() => {
    getAllRolecall
      .execute({ groupId: idGroup })
      .then((res) => setListRole(res));
  }, []);
                ...
                <>
                  ...
                  <Form.Item
                    ...
                    rules={[
                      ...
                      {
                        validator: (rule, value) =>
                          checkValidSpaces(rule, value, "expiredAt"),
                      },
                    ]}
                  >
                    <DatePicker
